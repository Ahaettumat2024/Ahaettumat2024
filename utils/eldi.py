...
LATE_RETURNS_PROP = 0.0015 # Proportion of Late escapees that return to rivers
EARLY_RETURNS_PROP = 0.0015 # Proportion of Early escapees that return to rivers
